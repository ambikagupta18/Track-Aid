...
public class rfetch extends Composite{

	private static rfetchUiBinder uiBinder = GWT.create(rfetchUiBinder.class);
	GreetingServiceAsync a1=GWT.create(GreetingService.class);

	interface rfetchUiBinder extends UiBinder<Widget, rfetch> {
	}
